<?php 
   ...
   if(!isset($_SESSION)){
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO sender_info(lastname,firstname,middlename,age,contact,email,street,baranggay,can,noodles,drinks,rice,babyfood,snacks,householdgoods,hygiene,datetime) VALUES ('$lname','$fname','$mname','$age','$contact','$email','$street','$baranggay','$can','$noodles','$drinks','$rice','$babyfood','$snacks','$household','$hygiene','$datetime')";
        ...
        <div class="main-container border-start shadow mb-5 bg-white rounded">
            ...
            <section class="list-form">
                ...
                <form method="post">
                    ...
                    <div>
                        <label class="numfam">Age</label> <br>
                        <input type="text" class="form-control numfams" placeholder="Age" aria-label="Username" name="age" autocomplete="off">
                    </div>
                    <div>
                    ...
                    <div>
                    <label class="date">Date Time</label> <br>
                        <input type="datetime-local" class="form-control address dates" aria-label="Username" name="datetime" autocomplete="off" required>
                    </div>
